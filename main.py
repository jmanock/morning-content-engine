...
def build_parser() -> argparse.ArgumentParser:
    ...
    subparsers.add_parser("collect-signals", help="Copy enabled external outbox signals into signals/inbox")
    subparsers.add_parser("import-signals", help="Import pending JSON signal files from signals/inbox")
    signals_parser = subparsers.add_parser("signals", help="List recently imported signals")
...
def main() -> None:
    ...
    if args.command == "morning":
        ...
        for line in collect_signal_lines():
            print(line)
